...
<div id="container">
    <div id="content-area">
        ...
        <div class="product-box">
            ...
            <img src="images/medecinestock.png" title="Click to do something" width="128" height="128" border="0"/>
            <span> Get Medicine Stock</span>
            </a>
            </h2>
        </div>
        <div class="product-box">
                    <h2>
                    <a href="samlsso?SAML2.HTTPBinding=HTTP-Redirect">
                    <img src="images/medical-kit.png" title="Click to do something" width="128" height="128" border="0"/>
                    <span> View most commonly used medicine</span>
                    </a>
                    </h2>
        </div>
    </div>
